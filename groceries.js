...
itemlistli.forEach((e, i) => {
  ...
  itemPrices[i].textContent = "£"+item[`${i}`].price+".00";
});
page1.onclick=()=>{
  ...
  itemPrices[0].textContent = "£"+item[0].price;
  p2=false;
...
page2.onclick=()=>{
  ...
  itemPrices[0].textContent = "£"+item[9].price;
  p2=true;
...
sortLiBox.children[1].onclick=(e)=>{
  itemlistli.forEach((e, i) => {
    ...
    itemPrices[i].textContent = "£"+sortbypopularity[`${i}`].price+".00";
  });
  sortLi.textContent = e.target.textContent;
  if (isAppered) {
    sortLiBox.classList.toggle("hide") ;
...
sortLiBox.children[2].onclick=(e)=>{
  itemlistli.forEach((e, i) => {
    ...
    itemPrices[i].textContent = "£"+sortbyaverage[`${i}`].price+".00";
  });
  sortLi.textContent = e.target.textContent;
  if (isAppered) {
    sortLiBox.classList.toggle("hide") ;
...
sortLiBox.children[3].onclick=(e)=>{
  itemlistli.forEach((e, i) => {
    ...
    itemPrices[i].textContent = "£"+sortbylatest[`${i}`].price+".00";
  });
  sortLi.textContent = e.target.textContent;
  if (isAppered) {
    sortLiBox.classList.toggle("hide") ;
...
sortLiBox.children[4].onclick=(e)=>{
  itemlistli.forEach((e, i) => {
    ...
    itemPrices[i].textContent = "£"+sortbyHighPrice[`${i}`].price+".00";
  });
  sortLi.textContent = e.target.textContent;
  if (isAppered) {
    sortLiBox.classList.toggle("hide") ;
...
sortLiBox.children[5].onclick=(e)=>{
  itemlistli.forEach((e, i) => {
    ...
    itemPrices[i].textContent = "£"+sortbyLowPrice[`${i}`].price+".00";
  });
  sortLi.textContent = e.target.textContent;
  if (isAppered) {
    sortLiBox.classList.toggle("hide") ;
...
itemlistli.forEach((e,i) => {
  e.onclick = (el) => {
   ...
   localStorage.setItem("price",itemPrices[i].innerText)
   localStorage.setItem("tag",itemName[i].innerText)
  };
});